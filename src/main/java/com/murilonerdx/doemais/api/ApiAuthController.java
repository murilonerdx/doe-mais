...
public class ApiAuthController {
  ...
  @Autowired OngRepository ongRepository;
  ...
  @GetMapping("/user")
  public ResponseEntity<OngDTO>
  getOng(HttpServletRequest request) {
    String username =
        tokenProvider.getUsername(tokenProvider.resolveToken(request));
    Ong ong =
        ongRepository.findByUser(repository.findByUsername(username).get());
    if (ong == null) {
      throw new AuthorizationException(
          "Você precisa ser uma ong para acessar esse endpoint");
    }
